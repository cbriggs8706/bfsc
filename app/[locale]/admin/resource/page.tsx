// app/[locale]/admin/resource/page.tsx
	...
	return (
		<div className="p-4 space-y-4">
			...
			<div className="flex items-center justify-between">
				...
				<Link href={`/${locale}/admin/resource/create`}>
									...
									{items.map((r) => (
										...
										>
											...
											<div className="flex gap-3 text-sm">
												<Link href={`/${locale}/admin/resource/${r.id}`}>
													<Button size="sm" variant="outline">
														{t('viewDetails')}
													</Button>
												</Link>

												<Link href={`/${locale}/admin/resource/update/${r.id}`}>
													<Button size="sm">{t('edit')}</Button>
												</Link>

												<Link href={`/${locale}/admin/resource/delete/${r.id}`}>
