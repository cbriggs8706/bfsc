...
ALTER TABLE "reservations" ADD CONSTRAINT "reservations_assigned_consultant_id_public.user_id_fk" FOREIGN KEY ("assigned_consultant_id") REFERENCES "public"."public.user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
