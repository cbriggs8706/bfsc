...
--> statement-breakpoint
ALTER TABLE "reservation" DROP CONSTRAINT "reservations_assigned_worker_id_public.user_id_fk";
--> statement-breakpoint
...
ALTER TABLE "reservation" ADD CONSTRAINT "reservation_assigned_worker_id_public.user_id_fk" FOREIGN KEY ("assigned_worker_id") REFERENCES "public"."public.user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
